...
namespace Matrizes.Modelo
{
    ...
    public class Fraction
	{
        ...
        public Fraction(double iNumerator, double iDenominator)
        {
            Initialize(iNumerator, iDenominator, true);
        }

        public Fraction(double iNumerator, double iDenominator, bool signal)
        {
            Initialize(iNumerator, iDenominator, signal);
        }
        ...
        /// Internal function for constructors
        /// </summary>
        private void Initialize(double iNumerator, double iDenominator, bool signal)
        {
		...
		public static Fraction ToFraction(string strValue)
		{
            ...
            double iNumerator = Convert.ToDouble(strValue.Substring(0,i));
			double iDenominator= Convert.ToDouble(strValue.Substring(i+1));
		...
		public static Fraction Inverse(Fraction frac1)
		{
			...
			double iNumerator=frac1.Denominator;
			double iDenominator=frac1.Numerator;
		...
		/// </summary>
   		...
   		{
			return ( Convert.ToInt32((Convert.ToInt32(Numerator) ^ Convert.ToInt32(Denominator)) & 0xFFFFFFFF) ) ;
		}
        ...
        private static Fraction Negate(Fraction frac1)
		{
			...
			double iDenominator=frac1.Denominator;
		...
		private static Fraction Add(Fraction frac1, Fraction frac2)
		{
			try
			{
				checked
				{
                    ...
                    double iDenominator =frac1.Denominator*frac2.Denominator;
					return ( new Fraction(iNumerator, iDenominator, signal) );
				}
			}
			catch(OverflowException)
		...
		private static double GCD(double iNo1, double iNo2)
		{
			...
			do
			{
				...
				iNo1 = Convert.ToUInt64(iNo1 % iNo2);
			} while (iNo1 != 0);
			return iNo2;
		}
		...
		public static void ReduceFraction(Fraction frac)
		{
			try
			{
				...
				frac.Numerator= Convert.ToUInt64(frac.Numerator/iGCD);
				frac.Denominator= Convert.ToUInt64(frac.Denominator/iGCD);
                frac.Signal = signal;
