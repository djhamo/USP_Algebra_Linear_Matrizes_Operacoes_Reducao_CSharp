...
namespace Matrizes.Modelo
{
    ...
    ///     * Change Numerator and Denominator type to BigInteger (System.Numerics)
    ///     * New Constructor for BigInteger type
    ...
    public class Fraction
	{
		...
		//long m_iNumerator;
		//long m_iDenominator;
        BigInteger m_iNumerator;
        BigInteger m_iDenominator;
        ...
        //{
        //	Numerator= new BigInteger(iNumerator);
        //	Denominator= new BigInteger(iDenominator);
        //	ReduceFraction(this);
        //}
        ...
        /// <summary>
		/// The function returns the current Fraction object as BigInteger
		/// </summary>
		...
		private static BigInteger GCD(BigInteger iNo1, BigInteger iNo2)
		{
			...
			do
			{
				if (iNo1 < iNo2)
				{
                    BigInteger tmp = iNo1;  // swap the two operands
					iNo1 = iNo2;
					iNo2 = tmp;
				}
				iNo1 = iNo1 % iNo2;
		...
		public static void ReduceFraction(Fraction frac)
		{
			try
			{
				...
				BigInteger iGCD=GCD(frac.Numerator, frac.Denominator);
				frac.Numerator/=iGCD;
